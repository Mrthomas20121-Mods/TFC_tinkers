...
public class TConstructHelper {
    ...
    public void preInit()
	{
	    TFC_Tinker.logger.info("Loading Materials");
        ...
        if(Config.bismuth) {
            ...
            bismuth.addTrait(TinkerTraits.dense, MaterialTypes.EXTRA);
        ...
        if(metallum) {
            ...
            if(Config.antimony) {
                ...
                antimony.addTrait(TinkerTraits.lightweight);
    ...
    public void registerMelting(Fluid f, String ore) {
        ...
        TinkerRegistry.registerMelting("ingotDouble" + ore, f, Materials.VALUE_DOUBLE_INGOT);
        TinkerRegistry.registerMelting("sheet" + ore, f, Materials.VALUE_SHEET);
        TinkerRegistry.registerMelting("sheetDouble" + ore, f, Materials.VALUE_DOUBLE_SHEET);
        if(tech) {
